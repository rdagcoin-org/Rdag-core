...
TEST(TestCoreRDAG, IndexStruct) {
    ...
    EXPECT_EQ(i2x.capacity(), 2);
    EXPECT_EQ(i2x.population(), 2);
    EXPECT_EQ(i2x.add(test3), RDAG::NULL_INDEX);
    EXPECT_EQ(i2x.population(), 2);
    EXPECT_EQ(i2x.index(test3), RDAG::NULL_INDEX);
    ...
    EXPECT_EQ(i4x.capacity(), 4);
    EXPECT_EQ(i4x.population(), 4);
    EXPECT_EQ(i4x.add(test5), RDAG::NULL_INDEX);
    EXPECT_EQ(i4x.population(), 4);
    EXPECT_EQ(i4x.index(test5), RDAG::NULL_INDEX);
}