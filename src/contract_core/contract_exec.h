...
// QPI context used to call contract system procedure from rdag core (contract processor)
...
// QPI context used to call contract user procedure from rdag core (contract processor)
...
// QPI context used to call contract user function from rdag core (request processor)
